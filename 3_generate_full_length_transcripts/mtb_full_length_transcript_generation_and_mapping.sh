...
filename_1="${filename_1%%.sam}"

samtools view -Sb  $sam_file >$filename_1.bam
samtools sort $filename_1.bam > $filename_1.sorted.bam
samtools index $filename_1.sorted.bam
...
rm  $filename_1\_PE_2_S.bowtie2mapping.sam $filename_1.bam $filename_1.sorted.bam $filename_1.sorted.bam.bai $filename_1\_PE_2_S.bowtie2mapping.bam 
